...
const data = {
    ...
    "thai" :
    {
        ...
        "nav-link2": "ติดต่อเรา",
        "nav-link dropdown-toggle": "ภาษาไทย",

        //Page1
        "title1": "เดินทางด้วยความสะดวก",
        "auto-type": "",
        "title2": "KU BUS  แอปติดตามและนำทางขนส่งแบบเรียลไทม์",

        //Page2
        "sub-title": "เพื่อนร่วมเดินทางของคุณ",
        "Text-Routes1": "ค้นหาเส้นทาง",
        "Text-Routes2": "ค้นหาจุดจอดและเส้นทางสำหรับ",
        "Text-Routes3": "มหาวิทยาลัยเกษตรศาสตร",
        "Text-TrackLive1": "ติดตามรถโดยสาร",
        "Text-TrackLive2": "ดูตำแหน่งรถบัสแบบเรียลไทม์ที่ใกล้ถึงจุด",
        "Text-TrackLive3": "จอดของคุณ",
        "Text-GetDirections1": "แนะนำเส้นทาง",
        "Text-GetDirections2": "ไม่รู้ว่าต้องตึกเรียนอะไร? KU BUS ",
        "Text-GetDirections3": "ก็ช่วยแนะนำเส้นทางให้คุณได้",
